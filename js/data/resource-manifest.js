window.ResourceManifest = (() => {
  const entries = {
    ...
    avatar_rhea: { id: "image:rhea", kind: "image", src: "./assets/images/characters/avatar-controller.png" },
    avatar_serin: { id: "image:serin", kind: "image", src: "./assets/images/characters/avatar-controller2.png" },
