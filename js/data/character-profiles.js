window.CHARACTER_PROFILES = {
  rhea: {
    ...
    name: "레이",
    shortName: "RH",
    avatarSrc: "./resources/avatar-controller.jpg",
    avatarFallbackSrc: "./resources/avatar-controller.png",
  ...
  serin: {
    ...
    name: "서린",
    shortName: "SR",
    avatarSrc: "./resources/avatar-controller2.jpg",
    avatarFallbackSrc: "./resources/avatar-controller2.png",
